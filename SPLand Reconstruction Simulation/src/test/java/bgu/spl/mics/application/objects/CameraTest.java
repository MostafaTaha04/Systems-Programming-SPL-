...
//         assertEquals(object1.getDetectedObjects(), camera.detectObject(5).getDetectedObjects());
//         assertEquals(object2.getDetectedObjects(), camera.detectObject(10).getDetectedObjects());
//     }
...
//         StampedDetectedObjects result = camera.detectObject(2);
...
//         StampedDetectedObjects result = camera.detectObject(4);
...
//         Camera camera = new Camera(dataPath, id, frequency, key);
//         StampedDetectedObjects result = camera.detectObject(99);
...
class CameraTest {
    ...
    public void testMultipleEntriesInDetectedObjectsList() {
        ...
        detectedObjectsList.add(new StampedDetectedObjects(5, objects1));
        detectedObjectsList.add(new StampedDetectedObjects(10, objects2));
        ...
        StampedDetectedObjects result1 = camera.detectObject(5);
        StampedDetectedObjects result2 = camera.detectObject(10);

        assertNotNull(result1, "Result1 should not be null");
        assertNotNull(result2, "Result2 should not be null");

        assertEquals(objects1, result1.getDetectedObjects(), "First detected objects should match");
        assertEquals(objects2, result2.getDetectedObjects(), "Second detected objects should match");
    }


    @Test
    public void testDetectObjectInvalidTime() {
        int id = 5;
        int frequency = 5;
        List<StampedDetectedObjects> detectedObjectsList = new ArrayList<>();

        detectedObjectsList.add(new StampedDetectedObjects(15, new ArrayList<>()));
