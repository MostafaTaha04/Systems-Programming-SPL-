...
public class FusionSlamService extends MicroService {
    ...
    protected void initialize() {
        subscribeBroadcast(CrashedBroadcast.class, crashed -> {
            System.out.println(crashed.getServiceName() + " crashed because " + crashed.getReason());
            fusionSlam.isCrashed(true);
            Errors.getInstance().setError(crashed.getReason());
            Errors.getInstance().FaultSensor(crashed.getServiceName());
            terminate();
        });
